...
class RecommendationEngine:
	...
	self.model = MatrixFactorizationModel.load(self.sc, "s3n://patricks3db/models")
	...
	ratings = self.model.recommendProducts(user_id, movies_count)
        return ratings
    ...
    def __init__(self, sc, dataset_path):
        ...
        self.__train_model() 
	#self.load(sc, "s3n://patricks3db/modelsComplete")
